...
class BaseReasoningFormatDetector:
    """
    Provide one-time and streaming detection of reasoning format in model output.
    """
    def __init__(
            self,
...
class ReasoningParser:
    """
    handle both streaming and non-streaming scenarios for extracting reasoning content from model output.
    """
